...
const ajouterMembre = async () => {
  try {
    await MembreService.createMembre(membreAjout.value);
...
<template>
  ...
  <div>
    ...
    <form @submit.prevent="ajouterMembre">
      <input v-model="membreAjout.nom" type="text" placeholder="Nom">
      <input v-model="membreAjout.prenom" type="text" placeholder="Prénom">
      <input v-model="membreAjout.dateNaissance" type="date" placeholder="Date de Naissance">
      <input v-model="membreAjout.adresse" type="text" placeholder="Adresse">
      <input v-model="membreAjout.mail" type="email" placeholder="Mail">
      <input v-model="membreAjout.motDePasse" type="password" placeholder="Mot de passe">
